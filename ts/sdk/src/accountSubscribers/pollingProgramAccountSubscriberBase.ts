...
export abstract class PollingProgramAccountSubscriberBase<
	Account,
	AccountEvents extends DriftCompetitionsProgramAccountBaseEvents
> implements DriftCompetitionsProgramAccountSubscriber<Account, AccountEvents>
{
	protected program: Program<DriftCompetitions>;
